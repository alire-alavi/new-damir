          ...
          <form action>
            ...
            <div id="password" class="inputs">
              <div class="formInputsWrapper">
                <input
                  autocomplete="off"
                  @blur="focusOut($event),startValidation('pass',$event)"
                  class="signupFormInputs inputWithLabelThatShouldStay"
                  id="userPassword"
                  type="password"
                />
            ...
            <div id="passwordConf" class="inputs">
              <div class="formInputsWrapper">
                <input
                  autocomplete="off"
                  @blur="focusOut($event),checkConfirmation($event)"
                  id="userPasswordCond inputWithLabelThatShouldStay"
